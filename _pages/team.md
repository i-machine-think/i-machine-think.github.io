---
title: "I-Machine-Think - Team"
layout: gridlay
excerpt: "I-Machine-Think: Team members"
sitemap: false
permalink: /team/
---
...
Jump to [project Leaders](#project-leaders), [master and bachelor students](#master-and-bachelor-students), [alumni](#alumni).
...
<div class="col-sm-6 clearfix">
  ...
  {% if member.number_interests == 1 %}
  <li> {{ member.interest1 }} </li>
  {% endif %}

  {% if member.number_interests == 2 %}
  <li> {{ member.interest1 }} </li>
  <li> {{ member.interest2 }} </li>
  {% endif %}

  {% if member.number_interests == 3 %}
  <li> {{ member.interest1 }} </li>
  <li> {{ member.interest2 }} </li>
...
<div class="col-sm-6 clearfix">
  <h4>{{ member.name }}</h4>
  {{member.role}}<br><i>{{ member.duration }}</i> <br>
  {% if member.info %} Current role: {{ member.info }} {% endif %}
</div>
